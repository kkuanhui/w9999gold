  ...
  return (
    ...
    >
      <div style={{width: "350px", height: "400px"}}>
        ...
        >
          <label htmlFor="email" className="font-size-15">信箱：</label>
        ...
        <div className="d-flex flex-ai-center flex-jc-between"
          style={{marginBottom: "15px"}}
        >
          <label htmlFor="email-2" className="font-size-15">信箱確認：</label>
          <input id="email-2" style={inputStyle}></input>
        </div>
        <div style={{marginBottom: "30px"}}>
          <small className="color-ff0000">您會需要這個信箱找回遺失的密碼</small>
        </div>


        <div className="d-flex flex-ai-center flex-jc-between mb-3">
          <label htmlFor="password" className="font-size-15">密碼：</label>
          <input id="password" style={inputStyle}></input>
        </div>

        <div className="d-flex flex-ai-center flex-jc-between mb-3">
          <label htmlFor="name" className="font-size-15">姓名：</label>
        ...
        <div className="d-flex flex-ai-center flex-jc-between" 
          style={{marginBottom: "15px"}}
        >
          <label htmlFor="phone" className="font-size-15">電話：</label>
